      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl lg:text-7xl font-display font-bold text-primary leading-tight mb-6">
            عطور فاخرة <br />
            <span className="text-secondary">مستوحاة من العطور العالمية</span>
          </h1>
        ...
        >
          <div className="relative w-full aspect-square max-w-md mx-auto">
            ...
            <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white shadow-2xl">
              <Image
                src="/assets/images/hero-aseel-portrait.png"
            ...
            >
              <p className="text-primary font-bold text-sm">زيوت فاخرة</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
