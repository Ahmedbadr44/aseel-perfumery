...
import { Truck, CreditCard, ShieldCheck, ArrowRight, AlertCircle, Copy, CheckCheck, X } from 'lucide-react';
...
const checkoutSchema = z.object({
  ...
  address: z.string().min(10, 'العنوان يجب أن يكون مفصلاً (10 أحرف على الأقل)'),
  paymentMethod: z.literal('vodafone_insta'),
}).refine((data) => {
  if (data.city === 'other') {
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            {[
              ...
              'التقط صورة لشاشة التأكيد (Screenshot)',
              'اضغط الزر أدناه وأرسل الصورة عبر واتساب',
            ].map((step, i) => (
          ...
          <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <label className="flex items-center p-4 border border-gray-200 rounded-2xl cursor-pointer hover:bg-gray-50 transition-all border-secondary">
                    <input
                      type="radio"
                    ...
                    <div className="mr-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">تحويل سريع وآمن (الدفع عند الاستلام غير متاح حالياً)</p>
                      </div>
                    </div>
                  </label>
                </div>
              ...
              >
                ...
                <ul className="text-xs text-red-700 space-y-2 list-disc pr-4">
                  ...
                  <li><strong>يجب</strong> التقاط صورة لشاشة التأكيد (Screenshot).</li>
                  <li>بعد الضغط على &quot;تأكيد الطلب&quot;، سيفتح الواتس اب لترسل ال Screenshot</li>
                </ul>
              </motion.div>
